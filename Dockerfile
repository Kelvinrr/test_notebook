...
RUN conda create -y -q -n py-env python=3.5 nose numpy pillow scipy pandas networkx scikit-image sqlalchemy numexpr dill cython
RUN source activate py-env
